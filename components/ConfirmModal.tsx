...
const ConfirmModal: React.FC<ConfirmModalProps> = ({
    ...
    return (
        ...
        >
            <div
                className="fixed inset-0 md:left-[var(--app-sidebar-width,0px)] z-[10001] flex items-center justify-center bg-slate-900/60 backdrop-blur-sm p-4 animate-in fade-in duration-200"
