...
// Função para validar API key fazendo uma chamada real Í  API
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-sm text-green-700 dark:text-green-300 mt-1">
                                    Conecta o modelo Í  internet para buscar informações atualizadas.
                                </p>
                            </div>
                            <label className="relative inline-flex items-center cursor-pointer">
                                <input
                            ...
                            <div className="p-3 bg-amber-50/50 dark:bg-amber-900/10 space-y-3 animate-in slide-in-from-top-2 duration-200">
                                ...
                                <div className="pt-2 border-t border-amber-200 dark:border-amber-500/20">
                                    <p className="text-xs text-amber-700 dark:text-amber-300">
                                        <strong>Como revogar:</strong> Remova sua chave de API a qualquer momento clicando no botão ðŸ—‘ï¸ ao lado do campo.
