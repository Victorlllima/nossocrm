...
export const AICenterSettings: React.FC = () => {
  ...
  return (
    <div className="pb-10">
      ...
      {/* Org-wide toggle (admin-only) â€” sempre visÃ­vel no topo */}
        ...
        <div className="flex items-center justify-between gap-4">
          <div>
            <h2 className="text-base font-semibold text-slate-900 dark:text-white flex items-center gap-2">
              <span className="text-lg">âœ¨</span> IA ativa na organizaÃ§Ã£o
            </h2>
            <p className="text-sm text-slate-600 dark:text-slate-300 mt-1">
              Quando desligado, recursos de IA ficam indisponÃ­veis para toda a equipe.
            </p>
            {!isAdmin && (
              <p className="text-xs text-slate-500 dark:text-slate-400 mt-2">
                Apenas administradores podem alterar essa configuraÃ§Ã£o.
              </p>
            )}
          </div>
          <label className="relative inline-flex items-center cursor-pointer">
            <input
              ...
              aria-label="Ativar IA na organizaÃ§Ã£o"
            />
